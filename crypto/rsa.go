...
func GenerateKeyRSA() ([]byte, []byte, error) {
...
func DecryptRSA(_privateKey []byte, _data []byte) ([]byte, error) {
...
func EncryptRSA(_publicKey []byte, _data []byte) ([]byte, error) {
...
func SignRSA(_privateKey []byte, _data []byte) ([]byte, error) {
...
func VerifyRSA(_publicKey []byte, _data []byte, _sign []byte) error {
	hash := crypto.SHA256.New()
	hash.Write(_data)
	hashed := hash.Sum(nil)
	pub, err := parsePublicKey(_publicKey)
